...
> _Part I of our video tutorial [Mastering Spring RESTful Web Services Development](https://www.naturalprogrammer.com/p/spring-restful-web-services-tutorial-i) -- the ultimate course to master REST API development using Spring, whether you use Spring Lemon or not -- now available for [pre-order for FREE](https://www.naturalprogrammer.com/p/spring-restful-web-services-tutorial-i)!_
