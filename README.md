...
1. [Lemon Demo application](https://github.com/naturalprogrammer/lemon-demo). A sample application using Spring Lemon. Quite similar to the one developed in the [getting started guide](https://www.gitbook.com/book/naturalprogrammer/spring-lemon-getting-started/details), but additionally has automated tests.
1. [Demo Angular 1.x front-end application](https://github.com/naturalprogrammer/lemon-demo-angular1). A demo AngularJS 1.x front-end. It'll work both for the application developed in the [getting started guide](https://www.gitbook.com/book/naturalprogrammer/spring-lemon-getting-started/details) as well as the [Lemon Demo application](https://github.com/naturalprogrammer/lemon-demo). 
